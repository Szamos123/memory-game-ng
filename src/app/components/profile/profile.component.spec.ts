...
describe('ProfileComponent', () => {
  ...
  it('should change password successfully', fakeAsync(() => {
    ...
    const req = httpMock.expectOne(`https://681109923ac96f7119a35d5a.mockapi.io/user/${mockUser.id}`);
  ...
  it('should fetch user data on init', fakeAsync(() => {
    ...
    const req = httpMock.expectOne(`https://681109923ac96f7119a35d5a.mockapi.io/user?email=${email}`);
